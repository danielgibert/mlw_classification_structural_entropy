...
from src.method.utils import serialize_structural_entropy_example, extract_structural_entropy
import numpy as np
...
def dataset_to_tfrecords(pe_filepath,
    ...
    with open(labels_filepath, "r") as labels_file:
        ...
        for row in reader:
            ...
            serialized_example = serialize_structural_entropy_example(structural_entropy, int(row['Class']) - 1)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Entropy-based TFWriter Script')
